...
2 - crie um banco de dados postgreSQL (exemplo com docker): docker run --name shopee-system -e POSTGRES_PASSWORD=myPassword -e POSTGRES_USER=myUser -p 5432:5432 -d postgres
...
preencha as variáveis de ambiente com os dados do banco de dados seguindo o exemplo do comando docker acima, o arquivo config.properties ficaria assim: postgres_name=docker postgres_password=docker postgres_database=postgres postgres_port=5432 postgres_host=localhost
